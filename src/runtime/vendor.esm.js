...
export { isIndex, isNegIndex, NANOS, parseQJSON, parseSLID } from 'https://cdn.jsdelivr.net/gh/mesgjs/nanos@0.0.14/src/nanos.esm.js';
...
export { isIndex, isNegIndex, NANOS, parseQJSON, parseSLID } from 'https://cdn.jsdelivr.net/gh/mesgjs/nanos@0.0.14/dist/nanos.min.esm.js';
